...
[cx,c_v_x,c_a_x,c_j_x] = generate_polynomial_trajectory(initial_constrains_x,final_contrains_x,t0,tf);
[cy,c_v_y,c_a_y,c_j_y] = generate_polynomial_trajectory(initial_constrains_y,final_contrains_y,t0,tf);
[cz,c_v_z,c_a_z,c_j_z] = generate_polynomial_trajectory(initial_constrains_z,final_contrains_z,t0,tf);
...
for i = 1:(tf-t0)/time_step-1
    ...
    jerk = [polyval(c_j_x,t(i)),polyval(c_j_y,t(i)),polyval(c_j_z,t(i))]';
    psi = polyval(cPsi,t(i));
    dPsi = polyval(c_v_psi,t(i));
